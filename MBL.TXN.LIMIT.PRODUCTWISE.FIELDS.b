...
* <Rating>-7</Rating>
*-----------------------------------------------------------------------------
SUBROUTINE MBL.TXN.LIMIT.PRODUCTWISE.FIELDS
*-----------------------------------------------------------------------------
...
*------------------------------------------------------------------------------
*<doc>
* Template for field definitions routine MBL.TXN.LIMIT.PRODUCTWISE.FIELDS
*
...
*** </region>
*-----------------------------------------------------------------------------
    CALL Table.defineId("TXN.LIMIT.ID", T24_String) ;* Define Table id
*CALL Field.setCheckFile('CATEGORY')
    ID.N = '10'
    ID.CHECKFILE = 'CATEGORY'
*-----------------------------------------------------------------------------
