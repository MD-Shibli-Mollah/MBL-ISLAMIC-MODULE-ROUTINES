* @ValidationCode : MjoxNjQ3MzcxMzE5OkNwMTI1MjoxNTkzNTAyNTc3ODk3OnVzZXI6LTE6LTE6MDowOmZhbHNlOk4vQTpERVZfMjAxNzEwLjA6LTE6LTE=
* @ValidationInfo : Timestamp         : 30 Jun 2020 13:36:17
...
*Subroutine Description: This is a nofile enquiry routine where All the Opened deposits will be shown here.
...
SUBROUTINE GB.MBL.E.DEP.OPENED(Y.DATA)
*PROGRAM GB.MBL.E.DEP.OPENED
*-----------------------------------------------------------------------------
*
*-----------------------------------------------------------------------------
* Modification History :
*-----------------------------------------------------------------------------
*List of Opened deposit accounts for given period
*-----------------------------------------------------------------------------
...
*-----------------------------end--------------------------------------------------------
    ...
    SEL.CMD = 'SELECT ':FN.AC.DETAILS:' WITH VALUE.DATE GE ':Y.ST.DT:' AND VALUE.DATE LE ':Y.END.DT
*
